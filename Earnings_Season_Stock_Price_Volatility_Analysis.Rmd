...
```{r, include = FALSE}
Amazon_data = read_csv("~/Desktop/stat240/final_project/data/Amazon.csv")
tidy_Amazon = Amazon_data %>%
  filter(between(Date, as.Date("2012-05-18"), as.Date("2020-08-18")))
```

```{r, include = FALSE}
Apple_data = read_csv("~/Desktop/stat240/final_project/data/Apple.csv")
tidy_Apple = Apple_data %>%
  filter(between(Date, as.Date("2012-05-18"), as.Date("2020-08-18")))
```

```{r, include = FALSE}
Facebook_data = read_csv("~/Desktop/stat240/final_project/data/Facebook.csv")
tidy_Facebook = Facebook_data %>%
  filter(between(Date, as.Date("2012-05-18"), as.Date("2020-08-18")))
```

```{r, include = FALSE}
Google_data = read_csv("~/Desktop/stat240/final_project/data/Facebook.csv")
tidy_Google = Google_data %>%
  filter(between(Date, as.Date("2012-05-18"), as.Date("2020-08-18")))
```

```{r, include = FALSE}
Netflix_data = read_csv("~/Desktop/stat240/final_project/data/Netflix.csv")
